...
const Header = () => {
  ...
  return (
    <>
      {/* Mobile Header */}
      <div className='md:hidden flex justify-between items-center px-4 fixed top-0 w-full h-[60px] bg-white z-50 shadow-md'>
      ...
      {/* Desktop Header */}
      <div className='hidden md:flex justify-between items-center px-8 fixed top-0 w-full h-[60px] bg-white z-50 shadow-md'>
